...
import 'package:clean_architecture_flutter/core/widgets/custom_snak_bar.dart';
...
import 'package:clean_architecture_flutter/injection.dart';
    ...
    if (!isKeyboardOpen) {
      return Column(
        children: <Widget>[
          ...
          SizedBox(width: 60, height: 60, child: FlutterLogo()),
          Padding(
